...
<head>
    ...
    <title>Kartu Hasil Studi - {{ $student['nama'] }}</title>
    <style>
        body {
...
<body>
    ...
    <table class="header-table">
        <tr>
            <td class="logo-cell">
                <img src="{{ asset('assets/img/logo/polije.png') }}" alt="Logo" class="logo-img">
            </td>
            <td class="text-cell">
    ...
    <table class="grades-table">
        ...
        <tbody>
            @foreach ($mata_kuliah as $index => $mk)
                <tr>
                    <td class="center grey">{{ $index + 1 }}</td>
                    <td class="center grey">{{ $mk['kode'] }}</td>
                    <td class="left grey">{{ strtoupper($mk['nama']) }}</td>
                    <td class="center dark-grey">{{ $mk['hm'] }}</td>
                    <td class="center dark-grey">{{ $mk['am'] }}</td>
                    <td class="center dark-grey">{{ $mk['k'] }}</td>
                    <td class="center dark-grey">{{ $mk['m'] }}</td>
                </tr>
            @endforeach
    ...
    <div class="footer-container">
        ...
        <div class="signature-col">
            ...
            <div class="signature-block">
                <div>Jember, {{ $tanggal }}</div>
                <div>KETUA JURUSAN TEKNOLOGI INFORMASI</div>
                <div class="signature-space"></div>
                <div>{{ $ketua_jurusan }}</div>
                <div>NIP. {{ $nip_ketua }}</div>
            </div>
