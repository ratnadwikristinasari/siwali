<div class="row gy-6">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">{{ $analyticsSummary['total_students_active'] ?? 0 }}</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ms-3">
                                ...
                                <h5 class="mb-0">{{ $analyticsSummary['total_employees_active'] ?? 0 }}</h5>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    {{-- Top IPK Leaderboard Program Studi --}}
    <div class="col-xl-12 col-md-12">
        <div class="card h-100">
            <div class="card-header pb-0">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div>
                        <h5 class="card-title mb-1">10 IPK Tertinggi Mahasiswa Program Studi</h5>
